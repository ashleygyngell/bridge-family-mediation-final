    ...
    <>
      ...
      <body className="columns is-mobile is-tablet pl-6 pr-6 ">
        <div className="content  ">
          <div className="title is-3 mt-4 mr-6 ml-6">What does it cost?</div>
          <div className="column pt-5 pl-6 pr-6 pb-6 is-12-desktop is-12-tablet is-12-mobile mediator-text  ">
            <p>
              ...
              account and will not present you with a large unexpected bill at
              the end. We are happy to discuss individual circumstances based on
              your ability to pay.{' '}
            </p>
            ...
            <bl>
              ...
              <li>
                Memorandum of Understanding or Summary of Proposals: £120 per
                hour per person (normally in the region of 1.5 hours work).
              </li>
              <li>
            ...
            <p>
              ...
              Legal Aid. We do not currently offer this but we can refer you to
              a practice with a Legal Aid franchise.
            </p>
          </div>
